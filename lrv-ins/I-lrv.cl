...
(defun i.sb (rs rb imm12)
 "(i.sb rs rb imm12)
  ...
  (emit-vait (store imm12 rs rb 0))
  )

(defun i.sj (rs rb imm12)
 "(i.sj rs rb imm12)
  ...
  this address. Note: Syntax different from standard."
  (emit-vait (store imm12 rs rb 1))
  )

(defun i.sv (rs rb imm12)
 "(i.sv rs rb imm12)
